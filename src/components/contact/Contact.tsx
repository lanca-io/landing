...
const Contact: FC<ContactProps> = ({ isOpen, toggleOpen }) => {
    ...
    const inputFields = useMemo(() => [
        ...
        { name: 'email', placeholder: 'your@mail.com', size: 'small' as TextInputSize, error: errors.email, type: 'email' },
        { name: 'message', placeholder: 'Hello Lanca!', size: 'large' as TextInputSize, error: errors.message },
    ], [errors]) as { name: FormDataKey, placeholder: string, size: TextInputSize, error?: string, type?: string }[];
