...
const SwapCard: FC = (): JSX.Element => {
	return (
		<div className={classNames['swap-card']}>
			<TokenArea direction="from" token='ETH' chain='Optimism' tokenLogoURL='/ETH.svg' chainLogoURL='/Optimism.svg' />
			<Direction />
			<TokenArea direction="to" token='USDC' chain='Polygon' tokenLogoURL='/USDC.svg' chainLogoURL='/Polygon.svg'/>
			<Divider />
